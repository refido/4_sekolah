          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="https://objectstorage.ap-sydney-1.oraclecloud.com/n/sdlnnagqepsh/b/4_sekolah/o/dist%2Fimg%2Fgambar.png" class="user-image" alt="User Image">
                <span class="hidden-xs"><?php echo $_SESSION['username']; ?></span>
              </a>
              <ul class="dropdown-menu">

                <li class="user-header">
                  <img src="https://objectstorage.ap-sydney-1.oraclecloud.com/n/sdlnnagqepsh/b/4_sekolah/o/dist%2Fimg%2Fgambar.png" class="img-circle" alt="User Image">
                  <p>
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="?page=upfot"><i class="fa fa-circle-o"></i>Upload Foto</a></li>
            </ul>
          </li>
          <li>
            <a href="logout.php">
